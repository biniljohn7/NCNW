(function () {
    $(document).ready(function () {
        ...
        function MonthlyGraph(
            ...
            for (const nations in nData.nations) {
                const data = nData.nations[nations];
                ntData += `<option value="${data.id}">
                                ${data.name}
                            </option>`;
            }
            ...
            selVal = _e('nationId');
            xhr.data.id = selVal.value;

            selVal.onchange = function () {
                xhr.data.id = this.value;
                renderGraph();
            }
