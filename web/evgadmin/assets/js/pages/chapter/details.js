(function () {
    ...
    $(document).ready(function () {
        ...
        _e('addPrecedent').onclick = addPrecedentFun;
    });
    ...
    function setMbrAsLeader() {
        ...
        $.ajax(
            ...
            method: 'post',
            data: {
                method: 'set-section-leader',
                mId: mId,
                chptrId: pgData.chptrId,
                type: type
            },
            error: setMbrError,
    ...
    function setMbrSuccess(data) {
        if (data.status == 'ok') {
            popup.hide();
            pix.openNotification('The section leader is added successfully.', 1);
