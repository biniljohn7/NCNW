(function () {
    ...
    $(document).ready(function () {
        $(".enable-inp-chk").on('change', setDelegate);
    ...
    function setDelegate() {
        ...
        let chapter = $('#current_chapter_' + member).val();
        $.ajax(
            domain + 'ajax/anyadmin/', {
            method: 'post',
            data: {
                method: 'set-section-delegate',
                mId: member,
                action: action,
                chapter: chapter
            },
            error: setDelError,
            success: setDelSuccess
        });
    }

    function setDelError(data) {
        popup.hide();
        popup.showError(
